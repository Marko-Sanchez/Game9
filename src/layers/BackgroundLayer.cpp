...
m_window(window)
{
    ...
    m_background = std::make_unique<Manager::SceneHandler>(shader, m_window, texture);
...
void BackgroundLayer::OnEvent(Event::Event& event)
{
    Event::EventDispatcher dispatcher(event);
    dispatcher.Dispatch<Event::MouseButtonPressedEvent>([this](Event::MouseButtonPressedEvent& e){return OnMouseButtonPressed(e);});
    dispatcher.Dispatch<Event::MouseMovedEvent>([this](Event::MouseMovedEvent& e){return OnMouseMoved(e);});
    dispatcher.Dispatch<Event::MouseButtonReleasedEvent>([this](Event::MouseButtonReleasedEvent& e){return OnMouseButtonReleased(e);});
}
...
bool BackgroundLayer::OnMouseButtonPressed(Event::MouseButtonPressedEvent& event)
{
 ...
 */
bool BackgroundLayer::OnMouseMoved(Event::MouseMovedEvent& event)
{
...
bool BackgroundLayer::OnMouseButtonReleased(Event::MouseButtonReleasedEvent& event)
{
    if (event.GetMouseButton() == GLFW_MOUSE_BUTTON_LEFT)
    {
